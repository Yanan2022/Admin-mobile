                    ...
                    <div class="col-6"> 
                        <div class="form-group p-2 border">
                            <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="app_url_android_status">
                                <span>{{__('messages.app_url')}} ({{__('messages.play_store')}}) <span class="input-label-secondary" title=""><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt=""></span></span>
                    ...
                    <div class="col-6"> 
                        <div class="form-group p-2 border">
                            <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="app_url_ios_status">
                                <span>{{__('messages.app_url')}} ({{__('messages.app_store')}}) <span class="input-label-secondary" title=""><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt=""></span></span>
                    ...
                    <div class="col-6"> 
                        <div class="form-group p-2 border">
                            <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="web_app_url_status">
                                <span>{{__('messages.web_app_url')}} <span class="input-label-secondary" title=""><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt=""></span></span>
